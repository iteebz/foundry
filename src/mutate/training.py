...
def mutate_batch_size(
    batch_size: int, base_config: dict[str, Any] | None = None
) -> dict[str, Any]:
...
def mutate_warmup(
    warmup_iters: int, base_config: dict[str, Any] | None = None
) -> dict[str, Any]:
...
def mutate_grad_clip(
    grad_clip: float, base_config: dict[str, Any] | None = None
) -> dict[str, Any]:
...
def mutate_lora_alpha(
    lora_alpha: int, base_config: dict[str, Any] | None = None
) -> dict[str, Any]:
