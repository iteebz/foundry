...
from benchmarks.constitution import evaluate_constitution, evaluate_helpfulness, score_preference_pair
...
def test_score_preference_pair():
    ...
    score = score_preference_pair(
        model, tokenizer, chosen="Good answer", rejected="Bad answer"
    )
