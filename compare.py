...
def compare(baseline_path: str, mutation_path: str) -> None:
    ...
    if baseline_result['val_loss'] and mutation_result['val_loss']:
        ...
        report = {
            ...
            "winner": mutation_result['experiment'] if mutation_result['val_loss'] < baseline_result['val_loss'] else baseline_result['experiment'],
            "improvement_pct": improvement
        }
        
        report_path = Path("out") / f"compare_{baseline_result['experiment']}_vs_{mutation_result['experiment']}.json"
